...
def collect_storage_state_files(storage_dir: str = DEFAULT_STORAGE_DIR, include_runtime: bool = False) -> dict[str, dict]:
...
def main() -> int:
	...
	payload = collect_storage_state_files(args.storage_dir, include_runtime=args.include_runtime)
	if not payload:
		print('{}')
		return 1
